...
gh        = Risebox::Core::Metric.create name: "Dureté totale (GH)",            code: 'GH',    unit: '°d',      display_order: 10
kh        = Risebox::Core::Metric.create name: "Dureté carbonnée (KH)",         code: 'KH',    unit: '°d',      display_order: 11
